...
const Meeting: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  return (
    <div
      className={`w-5 h-auto aspect-content flex flex-col justify-center items-center absolute bottom[-5px] left-0 rounded-full text-white p-0.5 bg-accent cursor-pointer`}
      {...props}
    >
      {children}
    </div>
